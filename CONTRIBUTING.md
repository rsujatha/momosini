...
- Small PRs. Review before merge. Merge when the Definition of Done is met.
...
2. **Instruction layer** — `agent/instructions.py` is changed with care. It's where the
...
## Secrets (also the Security concept)
